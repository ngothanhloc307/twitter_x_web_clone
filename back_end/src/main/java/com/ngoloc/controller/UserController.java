...
import com.ngoloc.mapper.UserDtoMapper;
import com.ngoloc.model.User;
import com.ngoloc.service.UserService;
import com.ngoloc.util.UserUtil;
...
public class UserController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<UserDto>> sreachUser(@RequestParam String query, @RequestHeader("Authorization") String jwt)
            throws UserException {
        User reqUser = userService.findUserProfileByJwt(jwt);
    ...
    @PutMapping("/update")
    public ResponseEntity<UserDto> sreachUser(@RequestBody User req, @RequestHeader("Authorization") String jwt)
            throws UserException {
        User reqUser = userService.findUserProfileByJwt(jwt);
