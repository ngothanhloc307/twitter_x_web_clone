...
export default function SubscriptionModal({ handleClose, open }) {
  ...
  const features = [
    ...
    'See approximately twice as many Tweets between ads in your For You and Follwing timelines.',
    'Add bold and italic text in you Tweets.',
    'Post longer video and 1080p video uploads',
    'All the existing Blue features, including Edit Tweets, Bookmark Folders and early access to new features',
  ];
            ...
            <div className='w-[80%] space-y-10'>
              <div className='p-5 rounded-md flex items-center justify-between bg-slate-400 shadow-lg'>
                <h1 className='text-xl pr-5'>
                  Blue subcribers with a verified phone number will get a blue checkmark once
                  approved.
                </h1>
                <img
                  className='w-24 h-24'
              ...
              <div className='cursor-pointer flex justify-center bg-gray-700 text-white rounded-full px-5 py-3'>
                <span className='line-through italic'>$8.00</span>
                <span className='px-5'>$84.00/year</span>
              </div>
            </div>
          </div>
        </Box>
